GTCEuStartupEvents.registry('gtceu:machine', event => {
	...
	event.create('primitive_bender', 'multiblock')
		...
		.pattern(definition => FactoryBlockPattern.start()
			...
			.build())
		.workableCasingModel("kubejs:block/casings/solid_wrought_iron/solid_wrought_iron_casing", "gtceu:block/machines/bender")
