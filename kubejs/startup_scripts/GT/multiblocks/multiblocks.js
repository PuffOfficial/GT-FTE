...
GTCEuStartupEvents.registry(`gtceu:machine`, event => {
	...
	event.create(`large_crucible`, `multiblock`)
		...
		.recipeType(`crucible`)
		.recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_PERFECT_SUBTICK])
		.appearanceBlock(() => Block.getBlock(`kubejs:porcelain_bricks`))
		.pattern(definition => FactoryBlockPattern.start()
			.aisle("a   a", "ccccc", "d e d", "deeed", "aeeea", "beeeb", "  e  ", "     ")
			.aisle("     ", "c e c", " e e ", "e   e", "e   e", "e   e", " e e ", "  e  ")
			.aisle("     ", "ceeec", "e   e", "e   e", "e   e", "e   e", "e   e", " efe ")
			.aisle("     ", "c e c", " e e ", "e   e", "e   e", "e   e", " e e ", "  e  ")
			.aisle("a   a", "ccccc", "d e d", "deeed", "aeOea", "beeeb", "  e  ", "     ")
			...
			.where("e", Predicates.blocks("kubejs:porcelain_bricks")
	...
	event.create(`terrestrial`, `multiblock`)
		...
		.pattern(definition => FactoryBlockPattern.start()
			...
			.where(`A`, Predicates.blocks(`somemoreblocks:cut_gold`))
	...
	event.create(`stargate_example`, `multiblock`)
		...
		.appearanceBlock(() => Block.getBlock(`sgjourney:classic_stargate_ring_block`))
		.pattern(definition => FactoryBlockPattern.start()
			.aisle(` #HBH# `, `H#   #H`, `#     #`, `C     #`, `H     H`, `##   ##`, ` H#H#H `)
			.where(`C`, Predicates.controller(Predicates.blocks(definition.get())))
			.where(`#`, Predicates.blocks(`sgjourney:classic_stargate_ring_block`))
			.where(`H`, Predicates.blocks(`sgjourney:classic_stargate_chevron_block`))
