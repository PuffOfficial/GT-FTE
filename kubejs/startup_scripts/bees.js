...
global.BeesCombs = [
  ['ferrous', '#3a3a3a', '#ffffff', 'iron', false],
  ['aurous', '#3a3a3a', '#ecce6c', 'gold', false],
  ['cuprous', '#3a3a3a', '#ba6b4c', 'copper', false],
...
ForestryEvents.apiculture(apiculture => {
  function RegisterBee(Name, OutlineColor, BodyColor, Resource, isFluid) {
