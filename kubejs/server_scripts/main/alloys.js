const Alloys = [
    ...
    ['3x gtceu:radiation_resistant_alloy', ['gtceu:tungsten_dust','gtceu:nickel_dust','gtceu:copper_dust'],2048,200,true,false,"radiation_resistant_alloy",2],
    ...
    ['3x gtceu:chromium_molybdenum_steel_dust', ['gtceu:chromium_dust','gtceu:molybdenum','gtceu:steel_dust'],512,1200,true,false,'ch_steel',2]
]
