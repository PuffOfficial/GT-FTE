...
event.recipes.gtceu.fermenter(`gtfte:fermented_biomass`)
        .itemInputs(`4x minecraft:potato`)
        .itemOutputs(`3x gtceu:raw_starch_dust`)
        .duration(150)
...
event.recipes.gtceu.chemical_reactor(`gtfte:lactic_acid`)
        .itemInputs([`minecraft:sugar`,`12x gtceu:starch_dust`])
        .outputFluids([`gtceu:lactic_acid 2000`, `minecraft:water 3000`])
        .duration(800)
        .EUt(GTValues.VA[GTValues.LV]);
event.recipes.gtceu.chemical_reactor(`gtfte:tin_dioxide`)
        .itemInputs(`gtceu:tin_dust`)
        .inputFluids(`gtceu:oxygen 2000`)
        .itemOutputs(`gtceu:tin_dioxide_dust`)
        .duration(200)
        .EUt(GTValues.VA[GTValues.LV]);
event.recipes.gtceu.chemical_reactor(`gtfte:2_ethylhexanoic_acid`)
        .inputFluids([`gtceu:propylene 3000`, `gtceu:carbon_monoxide 2000`, `gtceu:hydrogen 3000`])
        .outputFluids(`gtceu:2_ethylhexanoic_acid 1000`)
...
event.recipes.gtceu.chemical_reactor(`gtfte:stannous_octoate`)
        ...
        .inputFluids([`gtceu:2_ethylhexanoic_acid 1000`])
        .itemOutputs(`gtceu:stannous_octoate_dust`)
...
event.recipes.gtceu.chemical_reactor(`gtfte:polylactic_acid`)
        ...
        .outputFluids([`gtceu:polylactic_acid 1296`,`minecraft:water 1000`])
        .duration(600)
        .EUt(GTValues.VA[GTValues.ULV]);
})